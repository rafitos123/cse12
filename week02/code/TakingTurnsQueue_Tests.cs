...
{   
    ...
    // Defect(s) Found: the error is the person was added in the incorrect position, they are removed from the queue and not added back in
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There was no Enqueue If statement for when the turn was less than or equal to 0.
